"""
量化交易系统 - 全局配置 (v14)
股票池: 农业银行(601288), 神火股份(000933), 赤峰黄金(600988),
        亚钾国际(000893), 锡业股份(000960), 西部矿业(601168)
时间框架: 5分钟/15分钟短线
"""
...
US_MAPPING = {
    ...
    "601168": {  # 西部矿业 → 铜矿 + 矿业ETF
        "FCX": {"weight": 0.6, "name": "自由港麦克莫兰(铜)"},
        "XME": {"weight": 0.4, "name": "金属矿业ETF"},
    },
    "600988": {  # 赤峰黄金 → 黄金ETF + 金矿股
        "GLD": {"weight": 0.6, "name": "黄金ETF"},
        "NEM": {"weight": 0.4, "name": "纽蒙特(金矿)"},
    },
    "000893": {  # 亚钾国际 → 化肥相关美股
        "MOS": {"weight": 0.5, "name": "美盛(化肥)"},
        "NTR": {"weight": 0.5, "name": "Nutrien(钾肥)"},
    },
    "601288": {  # 农业银行 → 银行ETF + 富国银行
        "KBE": {"weight": 0.6, "name": "银行ETF"},
        "WFC": {"weight": 0.4, "name": "富国银行"},
    },
}
